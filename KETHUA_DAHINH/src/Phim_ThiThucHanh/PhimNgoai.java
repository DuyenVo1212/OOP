...
public class PhimNgoai extends Phim{
	...
	public PhimNgoai(String maPhim, String tenPhim, LocalDate ngayChieu, String diaChi, int soSuatChieu, int giaSuatChieu, float thue) {
	...
	public static String tieuDe() {
		return String.format("%10s %15s %15s %15s %10s %15s %10s %15s", "ma Phim", "ten Phim" , "ngay Chieu", "dia Chi", "so Suat Chieu", "gia Suat Chieu", "doanhThu", "Thue (%)");
	}
