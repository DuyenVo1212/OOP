...
public class MayTinh extends Phong {
	...
	public boolean datChuan() {
		if ((soLuongMT / super.getDienTich()) < 1 / 1.5)
			return false;
		if ((super.getSoBongDen() / super.getDienTich()) < 1.0 / 10)
			return false;
		return true;
	}

	public static String tieuDe() {
		String str = String.format("%10s %10s %10s %15s %10s %15s", "Ma phong", "day nha", "dien tich", "so bong den",
				"chat luong", "so may tinh");
		return str;
	}
