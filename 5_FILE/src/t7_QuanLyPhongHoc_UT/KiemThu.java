...
public class KiemThu {
	...
	public static void nhapPThiNghiem(DanhSachPhong dsPhong) {
		...
		System.out.println(
				"nhap theo thu tu: Ma phong, day nha, dien tich, so bong den, chuyen nganh, suc chua, bon rua(true or false)");
		a.setMaPhong(scan.next());
		a.setDayNha(scan.next());
		a.setDienTich(scan.nextFloat());
		a.setSoBongDen(scan.nextInt());
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1: {
				...
				int chon = scan.nextInt();
				if (chon == 1)
					nhapPLyThuyet(dsPhong);
				else if (chon == 2)
					nhapPMayTinh(dsPhong);
				else
					nhapPThiNghiem(dsPhong);
				break;
			}
			case 2: {
				...
				if (i instanceof MayTinh)
					System.out.println(MayTinh.tieuDe());
				if (i instanceof LyThuyet)
					System.out.println(LyThuyet.tieuDe());
				if (i instanceof ThiNghiem)
					System.out.println(ThiNghiem.tieuDe());
			...
			case 8: {
				...
				if (dsPhong.updateSoMayTinh(x, soLuong))
