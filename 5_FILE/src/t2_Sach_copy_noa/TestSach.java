...
public class TestSach {
	...
	public static void main(String[] args) {
		...
		ls.ThemSach(new SachGK("GK1", LocalDate.of(2016,1,26), 60000, 5, "Vo Chuc Duyen", "Moi"));
		ls.ThemSach(new SachTK("TK", LocalDate.of(2017,3,2), 60000, 5, "Vo Chuc Duyen", 20));
		ls.ThemSach(new SachTK("TK", LocalDate.of(2017,3,2), 60000, 5, "Duyen", 20));
		int x;
		System.out.println("---------------------------------");
		...
		System.out.println("|\t5. Xuat sach theo nha xuat ban.");//loi
		System.out.println("|\t6. Xuat toan bo sach");
		System.out.println("|\t7. Tinh tong trung binh sach tham khao");
		System.out.println("|\t8. Xuat sach trong thang 3 nam 2019");
		...
		do {
			...
			case 3: {
				...
				// nhap","Don gia","So luong","Nha xuat ban","Tinh trang","Thuế phải nộp");
				ls.xuatSachGK();
				break;
			}
			case 4: {
