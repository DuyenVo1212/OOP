...
public class Testing {
	...
	public static void Menu() {
		...
		do {
			...
			System.out.println("4. Tong tien luong cua danh sach");
			System.out.println("5. Edit so ngay cong theo ma nhan vien");
			System.out.println("6. Xuat nhan vien ko hoan thanh");
			...
			case 5:
				int snc;
				String maNV;
				System.out.print("Nhap so ngay cong can sua: ");
				snc = sc.nextInt();
				sc.nextLine();
				System.out.println("Nhap maNV can sua: ");
				maNV = sc.nextLine();
				ls.EditSoNGayCong(maNV, snc);
				System.out.println("Ngay da sua");
				break;
			case 6:
