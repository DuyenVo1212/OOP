...
public class Test {
	public static void main(String[] args) throws Exception {
		...
		dsPhim.themPhim(pn1);
		dsPhim.themPhim(pngoai1);
		dsPhim.themPhim(pn2);
		dsPhim.themPhim(pngoai2);
		dsPhim.themPhim(pn3);
		dsPhim.themPhim(pngoai3);
		...
		System.out.print("Nhap moc thoi gian:(nam,thang,ngay) ");
		//phim xuat ra sau so vs ngay nhap
