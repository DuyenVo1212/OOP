...
public class TestSach {
	...
	public static void main(String[] args) {
		...
		ls.ThemSach(new SachTK("TK2", LocalDate.of(2016, 4, 15), 60000, 5, "Chuc Duyen", 20));
		...
		System.out.println("|\t7. Tinh tong trung binh cong don gia sach");
		System.out.println("|\t8. Xuat sach trong thang 3");
		System.out.println("|\t9. Xuat tong tien theo loai sach");
		System.out.println("|\t10. Xoa theo nha xuat ban.");
		...
		do {
			...
			case 3: {
				/*
				 * System.out.printf("%10s %10s %10s %10s %15s %15s", "maSach", "Ngaynhap",
				 * "Dongia", "Soluong", "Nhaxuatban", "Tinhtrang");
				 */
				ls.xuatSachGK();
				break;
			}
			case 4: {
				/*
				 * System.out.printf("%10s %10s %10s %10s %15s %15s", "maSach", "Ngaynhap",
				 * "Dongia", "Soluong", "Nhaxuatban", "Thue");
				 */
				ls.xuatSachTK();
				break;
			}
			...
			case 10: {
				String nxb;
				System.out.println("Nhap nxb can xoa: ");
				sc.nextLine();
				nxb = sc.nextLine();
				ls.xoaNXB(nxb);
				System.out.println("Nha xuat ban " + nxb + "da xoa");
