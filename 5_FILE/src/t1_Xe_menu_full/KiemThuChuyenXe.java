...
public class KiemThuChuyenXe {
	...
	public static String tieuDe1() {
		String s="";
		s+=String.format("%8s %20s %8s %10s %10s %10s","Mã Xe","Họ tên TX","Số Xe","Doanh Thu","Số KM","Số Tuyến");
		return s;
	}
	
	public static String tieuDe2() {
		String s="";
		s+=String.format("%8s %20s %8s %10s %20s %10s","Mã Xe","Họ tên TX","Số Xe","Doanh Thu","Nơi đến","Số ngày");
		return s;
	}
	...
	public static void menu() {
		...
		System.out.println("6.Tìm theo ten tai xe");
		System.out.println("7.Sắp Xếp ArrayList theo thứ tự giảm dần ");
		System.out.println("8.Sắp xếp theo doanh thu tang dan");
		System.out.println("9.Sắp xếp theo ten va doanh thu");
	...
	public static void main(String[] args) {
		...
		while(choise!=0) {
			...
			case 3: 
				...
				System.out.println("Doanh Thu Chuyến Xe Nội Thành " +fm.format(dsCx.tongDThuNoiThanh()));
				System.out.println("Doanh Thu Chuyến Xe Ngoại Thành " +fm.format(dsCx.tongDThuNgoaiThanh()));
				System.out.println("Tong tien " +fm.format(dsCx.TongTien()));
				break;
			case 4: 
				String hoi="";
			...
			case 5: 
				...
				dsCx.Sua(x);
				System.out.println("Da sua du lieu, chon 2 de kiem tra");
				break;
			case 6://loi
				System.out.println("nhập tên TX cần tìm");
				input.nextLine();
				hoTenTX = input.nextLine();
				int tim=dsCx.TimtenTX(hoTenTX);
